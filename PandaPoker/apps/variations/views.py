...
#from apps.variations.forms import VariationForm
from apps.stats.models import Game
from apps.variations.models import Variation
import operator

class IndexView(generic.ListView):
    template_name = 'variations.html'
    ...
    def get_queryset(self):
        ...
        for variation in variations:
            variation.times_played = Game.objects.filter(variation = variation).count()
